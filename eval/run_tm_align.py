...
from cif_parser import parse_cif_backbone_auto  # Assuming this can provide sequence length

def run_tmalign(file1, file2):
    try:
        result = subprocess.run(['TM-align', file1, file2], capture_output=True, text=True)
        tm_score = None
...
def process_files():
    ...
    for gt_file in ground_truth_files:
        ...
        if os.path.exists(pred_file):
            ...
            seq_length = parse_cif_backbone_auto(gt_file)  # This function will provide the length
