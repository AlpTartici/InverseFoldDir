...
from training.sample_utils import (
    compute_sampling_metrics, simplex_proj, save_results_to_files,
    generate_detailed_json_output, sample_multiple_proteins_with_trajectory,
    sample_multiple_proteins, sample_multiple_proteins_batched, sample_multiple_proteins_with_ensemble,
    adjust_batch_size_for_ensemble, THREE_TO_ONE, IDX_TO_AA, AA_TO_IDX, SINGLE_TO_TRIPLE,
    create_argument_parser, resolve_protein_sampling_mode, create_structural_ensemble, sample_with_ensemble_consensus
)
...
def main():
    ...
    if args.pdb_input is not None:
        ...
        from training.sample_utils import process_input_specification, CustomInputDataset
